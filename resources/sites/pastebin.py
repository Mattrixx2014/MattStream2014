...
CACHE = 'special://home/userdata/addon_data/plugin.video.MattStream2014/%s_cache.db' % SITE_IDENTIFIER
...
if '3.10' in PYVERSION:
    ...
    PATH = 'special://home/addons/plugin.video.MattStream2014/resources/lib/pasteCrypt310.pyc'
elif '3.11' in PYVERSION:
    REALCACHE = VSPath(CACHE)
    PATH = 'special://home/addons/plugin.video.MattStream2014/resources/lib/pasteCrypt311.pyc'
elif '2.' in PYVERSION:
    REALCACHE = VSPath(CACHE).decode('utf-8')
    PATH = 'special://home/addons/plugin.video.MattStream2014/resources/lib/pasteCrypt2.pyc'
else:  # autre Versions 3.0x
    REALCACHE = VSPath(CACHE)
    PATH = 'special://home/addons/plugin.video.MattStream2014/resources/lib/pasteCrypt3.pyc'
...
def showMenu():
    ...
    if not sMedia:
        ...
        if 0: #not xbmc.getCondVisibility('Window.IsActive(home)'):
...
def showMenuFolder():
    ...
    pasteListe = list(pasteListe.items())
