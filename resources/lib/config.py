...
class GestionCookie:
    PathCache = 'special://userdata/addon_data/plugin.video.MattStream2014'
...
class cConfig:
    ...
    # def __init__(self):
        ...
        # self.__sFileDB = os.path.join(self.__oCache,'MattStream2014.db').decode('utf-8')
...
def WindowsBoxes(sTitle, siteUrl, metaType, year, sSite, sFav, sCat):
    ...
    try:
        ...
        DIALOG.VSok("Veuillez vider le cache des métadonnées Paramètre - outils - 'vider le cache de MattStream2014'")
        pass
    ...
    class XMLDialog(xbmcgui.WindowXMLDialog):
        ...
        def onClick(self, controlId):
            if controlId == 11:
                ...
                self.setProperty('MattStream2014_menu', 'Person')
