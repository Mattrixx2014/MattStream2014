...
class cHome:
    ...
    def showVOD(self):
        ...
        oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        oGui.addDir('pastebin', 'showMenuFilms', self.addons.VSlang(30120), 'films.png', oOutputParameterHandler)

        oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        oGui.addDir('pastebin', 'showMenuTvShows', self.addons.VSlang(30121), 'series.png', oOutputParameterHandler)

        oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        oGui.addDir('pastebin', 'showMenu&pasteID=3', self.addons.VSlang(30112), 'buzz.png', oOutputParameterHandler)

        oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        oGui.addDir('pastebin', 'showMenu&pasteID=4', "Concerts & Spectacles", 'buzz.png', oOutputParameterHandler)

        oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        oGui.addDir('pastebin', 'showMenuMangas', self.addons.VSlang(30122), 'animes.png', oOutputParameterHandler)

        oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        oGui.addDir('pastebin', 'showMenu&pasteID=5', 'Dessin animés', 'dramas.png', oOutputParameterHandler)

        # ininteressant
        # oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        # oGui.addDir(SITE_IDENTIFIER, 'showNets', self.addons.VSlang(30114), 'dramas.png', oOutputParameterHandler)
    ...
    def showMyVideos(self):
        ...
        oOutputParameterHandler.addParameter('siteUrl', 'http://Mattrixx2014')
        oGui.addDir('pastebin', 'showMenuFolder', self.addons.VSlang(30362), 'host.png', oOutputParameterHandler)
    ...
    def showMovies(self):
        ...
        oGui.addDir('pastebin', 'showTMDB' , '%s (%s)' % (self.addons.VSlang(30120), self.addons.VSlang(30101)), 'news.png', oOutputParameterHandler)
