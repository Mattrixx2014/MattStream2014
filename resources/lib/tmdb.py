...
# Modif pour MattStream2014
# https://github.com/Kodi-MattStream2014/MattRixx2014-Kodi-addons/
import re
import string
import xbmcvfs
import json
...
class cTMDb:
    ...
    CACHE = 'special://home/userdata/addon_data/plugin.video.MattStream2014/video_cache.db'
    ...
    def getToken(self):
        ...
        if (total > 0):
            ...
            if not xbmc.getCondVisibility('system.platform.android'):
                ...
                qr.png(VSPath('special://home/userdata/addon_data/plugin.video.MattStream2014/qrcode.png'), scale=5)
                oSolver = cInputWindowYesNo(captcha='special://home/userdata/addon_data/plugin.video.MattStream2014/qrcode.png', msg="Scanner le QRCode pour acceder au lien d'autorisation", roundnum=1)
                retArg = oSolver.get()
                DIALOG = dialog()
                if retArg == "N":
                    return False
