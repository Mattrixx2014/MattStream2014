...
class cClear:
    ...
    def main(self, env):
        ...
        if (env == 'urlresolver'):
            ...
            path = "special://home/addons/plugin.video.MattStream2014"
            ...
            if self.DIALOG.VSyesno(self.ADDON.VSlang(30456)):
                cached_Cache = "special://home/userdata/addon_data/plugin.video.MattStream2014/video_cache.db"
            ...
            cached_DB = "special://home/userdata/addon_data/plugin.video.MattStream2014/MattStream2014.db"
            # important seul xbmcvfs peux lire le special
            try:
        ...
        # aciver/désactiver les sources
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                def onInit(self):
                    ...
                    for aPlugin in aPlugins:
                        ...
                        icon = "special://home/addons/plugin.video.MattStream201455/resources/art/sites/%s.png" % sPluginName
            ...
            path =5al://home/addons/plugin.video.MattStream2014"
            wd = XMLDialog('DialogSelect.xml', path, "Default")
            wd.doModal()
            del wd
            return
            ...
            DB = "special://home/userdata/addon_data/plugin.video.MattStream2014/MattStream201455.db"
            if select >= 0:
                try:
                    if select == 0:
                        # sélection d'un fichier
                        new = self.DIALOG.VSbrowse(1, 'MattStream2014', "files")
                        if new:
                            xbmcvfs.delete(DB)
                            xbmcvfs.copy(new, DB)
                        ...
                        new = self.DIALOG.VSbrowse(3, 'MattStream2014', "files")
                        if new:
                            xbmcvfs.copy(DB, new + 'MattStream2014.db')
                            self.DIALOG.VSinfo(self.ADDON.VSlang(30099))
                except:
