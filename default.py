...
#
# Tuto ici :
# https://github.com/Kodi-MattStream2014/MattRixx2014-Kodi-addons/wiki
#
####################
...
class main:
    ...
    def parseUrl(self):
        # Exclue les appels par des plugins qu'on ne sait pas gérer, par exemple : plugin://plugin.video.MattStream2014/extrafanart
...
# RunAddon(plugin.video.MattStream2014,function=setSettings&id1=plugin_cinemay_com&value1=true
